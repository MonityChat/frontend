...
/**
 * Component to divide the messages in different dates.
 */
...
/**
 * formats date
 * if it is in the last week it will display last "weekday"
 * and if older it will display the date
 */
function formatDate(time) {
  ...
  if (
    date.getTime() >= weekbefore.getTime() &&
