...
export default function ContactView() {
	const [contacts, setContacts] = useState(generateDummyContact(10));
	...
	useEffect(() => {
		...
		const incomingContacts = lastJsonMessage.content.users;
	...
	return (
		<div className="contact-view view">
			...
			<div className="scrollable">
				{contacts.length < 1 ?
				<span className="placeholder">Loading data...</span> : contacts.map((contact, i) => (
					<Contact
						key={i}
						name={contact.name}
