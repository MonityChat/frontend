        ...
        <ul className="list">
          <li>
            ...
            <div className="item">
              <input
                type="radio"
                defaultChecked={colorMode === COLOR_MODES.GRADIENT_COLOR}
                name="color-scheme"
                onClick={() => setColorMode(COLOR_MODES.GRADIENT_COLOR)}
              />
              ...
              >
                {Object.keys(GRADIENT_SCHEME).map((keyName, i) => (
                  <option
                    ...
                    selected={GRADIENT_SCHEME[keyName] === gradientScheme}
                  >
            ...
            <div className="item">
              <input
                type="radio"
                defaultChecked={colorMode === COLOR_MODES.SINGLE_COLOR}
                name="color-scheme"
                onClick={() => setColorMode(COLOR_MODES.SINGLE_COLOR)}
              />
              ...
              >
                {Object.keys(COLOR_SCHEME).map((keyName, i) => (
                  <option
                    ...
                    selected={COLOR_SCHEME[keyName] === colorScheme}
                  >
